...
- End users can more easily self-serve if they stray from the beaten path
  ...
  Server-oriented software is more likely to be open source than
  desktop-oriented software and therefore easier to package.
